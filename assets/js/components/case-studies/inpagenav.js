( function() {
	...
	function InPageNav( el ) {
		...
		this._$hero = this._$el.querySelector( '.js-in-page-nav-hero' );
		this._$content = this._$el.querySelector( '.js-in-page-nav-content' );
		this._$pageNav = this._$el.querySelector( '.js-in-page-nav' );
		this._$footer = document.querySelector( '.js-in-page-nav-footer' );
	...
	InPageNav.prototype = {
		...
		_setFooterWatcher: function( margin ) {
			var _this = this;
			var footerWatcher = ScrollMonitor.create( this._$footer, {
